    ...
    <Collapsible.Root className="fixed left-0 right-0 top-0 z-20 flex flex-col gap-6 border-b border-zinc-200 bg-white p-4 data-[state=open]:bottom-0 lg:right-auto lg:w-80 lg:border-r lg:px-5 lg:py-8 lg:data-[state=closed]:bottom-0 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      >
        ...
        <nav className="space-y-0.5">
          ...
          <NavItem title="Dashboard" icon={BarChart} href={''} />
          <NavItem title="Projects" icon={SquareStack} href={''} />
          <NavItem title="Tasks" icon={CheckSquare} href={''} />
          <NavItem title="Reporting" icon={Flag} href={''} />
          <NavItem title="Users" icon={Users} href={''} />
        </nav>

        <div className="mt-auto flex flex-col gap-6">
          <nav className="space-y-0.5">
            <NavItem title="Support" icon={LifeBuoy} href={''} />
            <NavItem title="Settings" icon={Cog} href={''} />
          </nav>
